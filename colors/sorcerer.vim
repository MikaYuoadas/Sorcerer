...
hi Directory              gui=NONE               guibg=bg         guifg=#1e90ff
...
hi MoreMsg                gui=bold               guibg=bg         guifg=#2e8b57
hi NonText                gui=NONE               guibg=bg         guifg=#404050
...
hi TabLineFill            gui=reverse            guibg=bg         guifg=fg
hi TabLineSel             gui=bold               guibg=bg         guifg=fg
hi Title                  gui=bold               guibg=NONE       guifg=#528b8b
hi Visual                 gui=NONE               guibg=#6688aa    guifg=#000000
hi WarningMsg             gui=NONE               guibg=bg         guifg=#ee9a00
